package main.java.com.vz.bs.pp;
...
import main.java.com.vz.bs.helper.ConnectionGetter;
...
public class PaymentProcessor {
	...
	public void sendToFinance() {
		...
		try {
			...
			ResultSet rs = st
					.executeQuery("Select i.*,j.outstanding_amount from PAYMENTS_SUMMARY i, payments_outstanding_summary j where BILL_CYCLE_DATE='20-aug-2015' and i.account_number=j.account_number ORDER BY i.account_number");
			...
			while (rs.next()) {
				...
				if(rs.wasNull())
					...
					paymentDateString=new SimpleDateFormat("dd/MM/yyyy").format(paymentDate);
